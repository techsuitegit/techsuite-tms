...
export class IamRepository {
  constructor(private readonly baseUrl = (process.env.IAM_API_BASE_URL ?? DEFAULT_IAM_BASE_URL).replace(/\/$/, "")) {}

  async postJson(path: string, body: unknown): Promise<{ status: number; data: unknown }> {
